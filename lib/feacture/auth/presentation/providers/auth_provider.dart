...
import 'package:handiman_v0/feacture/auth/infrastructure/errors/auth_errors.dart';
import 'package:handiman_v0/feacture/auth/infrastructure/repository/auth_repository_impl.dart';
import 'package:handiman_v0/feacture/shared/services/key_value_storage_services.dart';
import 'package:handiman_v0/feacture/shared/services/key_value_storage_services_impl.dart';
...
class AuthNotifier extends StateNotifier<AuthState> {
  ...
  AuthNotifier( {required this.authRepository, required this.keyValueStorageService}) : 
  super(AuthState()){
    checkAuthStatus();
  }
