...
import 'package:handiman_v0/feacture/auth/infrastructure/mappers/user_mapper.dart';
...
final dio = Dio(
  ...
  Future<User> login(String email, String password)  async {
      try {
       ...
       if(e.response?.statusCode == 401 ){
        throw CustomError(message: e.response?.data['message'] ?? 'Credenciales Invalidas');
       } 
       if(e.type == DioExceptionType.connectionTimeout ){
